...
Contact Page Go to the Register page: http://YOUR_APP.com/contact.html

 Try to submit the empty form and verify that an error message about the required fields appears
 Try to submit the form with an invalid email format and verify that a relevant error message appears
